...
public class UserController {
    ...
    public Result deleteUser(@PathVariable String userId) {
        ...
        if (x > 0) {//删除用户
            ...
            return Result.failure(Result.ResultCode.DELETE_FAILURE, "删除失败");
    }
    ...
    public Result getVerificationCode(@RequestParam String userId,
                                      @RequestParam int category) throws MessagingException {//获取验证码,后面是类别
    ...
    public Result retrievePassword(@RequestParam String userId,
                                   @RequestParam String code, @RequestParam String newPassword) {//验证码
